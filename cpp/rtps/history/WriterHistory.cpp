        ...
        WriteParams& wparams)
{
    ...
    // std::cout<<"---对应writer的history添加Change---"<<"Change "<<a_change->sequenceNumber<<" added with "<<a_change->serializedPayload.length<<" bytes"<<std::endl;
